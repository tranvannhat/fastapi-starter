# API messages
MS_UNAVAILABLE = "System is under maintenance, please try again later"
MS_INVALID_API_PATH = "System is under maintenance, please try again later"
DATA_RESPONSE_MALFORMED = "Something went wrong, please contact admin"
